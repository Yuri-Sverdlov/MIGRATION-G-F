...
**Текущий фокус.** Партии 1–5 и **TASK-06 (удаление G:)** **закрыты**. На G: остались: `MIGRATION-G-F`, `_MY_PROGRAMMING_3`, корневые файлы. Следующее: **TASK-07** (`_MY_PROGRAMMING_3`) или финал.
